...
//Kth Smallest elements in array
public class SelectionProcedure {
    ...
    public static void main(String[] args) {
        ...
        int k = sc.nextInt();
        int kth = selectionProcedure(arr, 0, arr.length - 1, k);
        if(k == -1)
        {
        ...
        {
            System.out.println(k + "st Smallest element is: " + kth);
        }
        else  if(k == 2)
        {
            System.out.println(k + "nd Smallest element is: " + kth);
        }
        else if(k == 3)
        {
